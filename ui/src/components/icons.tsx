...
// Traces: BASED-CHAT-TRANSCRIPT-UI — arrow into a tray, the conventional "save this to a file".
...
// Traces: BASED-CHAT-HISTORY-PICKER — a clock, the conventional "history" glyph.
