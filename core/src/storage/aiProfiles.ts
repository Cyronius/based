...
export interface AiProfile {
  ...
  /** Tool-step budget per agent run (BASED-AI-PROFILE-STEPCAP). Absent = AGENT_MAX_STEPS (30);
   *  exhausting it prompts the user to continue rather than ending the conversation. */
  maxToolSteps?: number;
  hasKey: boolean;
  createdAt: string;
  updatedAt: string;
